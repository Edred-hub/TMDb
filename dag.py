...
EMAIL_DETAILS = {
    'fromaddr' : 'tmbddastore@gmail.com',
    'pwd' : 'tmbd@2020', # if using gmail, please head to myaccount.google.com/lesssecureapps and enable the option
    'toaddr' : 'tmbddatastore@gmail.com'
}
